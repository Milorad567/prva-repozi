"""Da se napravi prazna lista vo koja korisnikot ke moze da gi vnese otcenite na nekoj ucenik. Da se soberat otcenite, da se presmeta prosek i da se ispecati kakov e uspehot na ucenikot
0-1.5  ne dovolen
1.5-2.5 dovolen
2.5-3.5 dobar
3.5-4.5 mn.dobar
