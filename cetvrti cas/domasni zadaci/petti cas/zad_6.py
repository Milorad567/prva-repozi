"""Da se napravi prazna lista vo koja korisnikot ke vnese 10 elementi. Programata da go prasa korisnikot da izbere koj element da se izbrise i toj element da se izbrise. 
