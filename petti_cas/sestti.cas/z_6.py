"""Da se napravi funkcija koga ke prima lista od broevi(vneseni od korisnikot), listata da gi najde 
i da gi vrati kako rezultat samo parnite broevi t.e. lista od parni broevi"""
